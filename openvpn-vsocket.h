...
typedef openvpn_vsocket_handle_t (*bind_function)(void *plugin_handle,
                                  const struct sockaddr *addr,
                                  openvpn_vsocket_socklen_t len);

typedef void (*request_event_function)(openvpn_vsocket_handle_t handle,
...
typedef unsigned (*pump_function)(openvpn_vsocket_handle_t handle);

typedef ssize_t (*recvfrom_function)(openvpn_vsocket_handle_t handle,
                                void *buf, size_t len,
                                struct sockaddr *addr,
                                openvpn_vsocket_socklen_t *addrlen);

typedef ssize_t (*sendto_function)(openvpn_vsocket_handle_t handle,
                      const void *buf, size_t len,
                      const struct sockaddr *addr,
                      openvpn_vsocket_socklen_t addrlen);

typedef void (*close_function)(openvpn_vsocket_handle_t handle);
...
struct openvpn_vsocket_vtab {
    ...
    request_event_function request_event;
    ...
    update_event_function update_event;
